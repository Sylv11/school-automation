...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.et_register_lastname = findViewById(R.id.et_register_lastname);
        this.et_register_firstname = findViewById(R.id.et_register_firstname);
        this.et_register_email = findViewById(R.id.et_register_email);
        this.et_register_password = findViewById(R.id.et_register_password);
    }
    ...
    public void onRegisterClickManager(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_register_registerAction:
                String lastname = this.et_register_lastname.getText().toString();
                String firstname = this.et_register_firstname.getText().toString();
                String email = this.et_register_email.getText().toString();
                String password = this.et_register_password.getText().toString();
